...
$display=DisplaySurface.new([320, 200], HWSURFACE|FULLSCREEN|DOUBLEBUF)
...
class Pong
    ...
    def play
        while true
            ...
            $display.print [2,2], @ball_dir[0].to_s, 0xffffffff
...
alku=Timer.ticks
Pong.new.play
aika = Timer.ticks - alku
puts "#$totframes times in #{aika} ticks => #{$totframes*1000.0/aika} fps"
