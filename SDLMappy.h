...
const int MER_NONE=0;			/* All the horrible things that can go wrong */
const int MER_OUTOFMEM=1;
const int MER_MAPLOADERROR=2;
const int MER_NOOPEN=3;

const signed char AN_END=-1;					/* Animation types, AN_END = end of anims */
const signed char AN_NONE=0;					/* No anim defined */
const signed char AN_LOOPF=1;					/* Loops from start to end, then jumps to start etc */
const signed char AN_LOOPR=2;					/* As above, but from end to start */
const signed char AN_ONCE=3;					/* Only plays once */
const signed char AN_ONCEH=4;					/* Only plays once, but holds end frame */
const signed char AN_PPFF=5;					/* Ping Pong start-end-start-end-start etc */
const signed char AN_PPRR=6;					/* Ping Pong end-start-end-start-end etc */
const signed char AN_PPRF=7;					/* Used signed charernally by playback */
const signed char AN_PPFR=8;					/* Used signed charernally by playback */
const signed char AN_ONCES=9;					/* Used signed charernally by playback */
