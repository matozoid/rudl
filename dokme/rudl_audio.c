...
@method Channel#fade_out( milliseconds )
Fades the channel to silence in @milliseconds milliseconds.
See @volume and @volume=
*/
...
/**
@method Channel#volume
Returns the current volume.
See @fade_out and @volume=
*/
...
/**
@method Channel#volume=( loudness )
Sets the volume to loudness.
...
@method Channel#busy -> true/false
...
/**
@method Channel#play( sound, loops, maxtime ) -> self
Plays @sound sound 1+@loops times, for a maximum time of maxtime milliseconds.
*/
/**
@method Channel#play( sound, loops ) -> self
Plays @sound sound 1+@loops times.
*/
/**
@method Channel#play( sound ) -> self
Plays @sound.
*/
...
/**
@method Channel#stop -> self
Stops sound playing on this channel.
*/
...
/**
@method Channel#set_panning( left, right ) -> self
...
/**
@method Channel#set_position( angle, distance ) -> self
